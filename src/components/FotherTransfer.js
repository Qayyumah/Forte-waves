...
import '../styles/FotherTransfer.css'

const FotherTransfer = () => {
  return (
    <div className='container'>
        <div className='body'>
            ...
            <div className='section-body-content'>
                ...
                <div className='section-body-fother-transfer'>
                    <div className='new-savings-fother-transfer'>
                        <h2 style={{fontSize:'25px', marginLeft:'23px', marginBottom: '40px'}}>F-F Transfer</h2>
                    </div>

                    <div className='new-border-fother-transfer'>
                    <div className='new-fother-transfer'>
                        <div className='p-fother-input'>
                            <p>Recepient's Bank*</p>
                            <input/>
                        </div>
                        <div className='p-fother-input'>
                            <p>Recepient's Account Number*</p>
                            <input type='select'/>
                        </div>
                        <div className='p-fother-input'>
                            <p>Amount*</p>
                    ...
                    <div className='btn-fother-transfer'>
