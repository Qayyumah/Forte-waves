...
import '../styles/InvestmentReturn.css'
    ...
    <div className='body'>
        ...
        <div className='section-body-content'>
            ...
            <div className='section-body-return'>
                ...
                <div className='new-border-investment-return'>
                    <div className='new-type-investment-return'>
                        <h3>How much would you like to invest</h3>
                    </div>
                    
                    <div className='inv-amount-return'>
                        <p>Amount to invest</p>
                        <div className='inv-amount-input-return'>
                            <input placeholder='Please enter an amount'/>
                        </div>
                    </div>

                    <div className='return-calc'>
                    ...
                    <div className='btn-investment-return'>
                        <Link to='/newinvestment'>Back</Link>
                        <Link to='/investmentsuccess'>Next</Link>
                    </div>
                </div>
            </div>
        </div>
